...
public class App {
  ...
  CalculatorFunction[] functions = {
    ...
    CalculatorFunction.SUBTRACTION,
    CalculatorFunction.MULTIPLCATION,
    CalculatorFunction.DIVISION,
    CalculatorFunction.SIN,
    CalculatorFunction.COS,
    CalculatorFunction.CIRCLE,
    CalculatorFunction.SPHERE
  };
  ...
  public void execute(int option) {
    ...
    if (function.isMultipleInput()) {
      ...
      double input = function == CalculatorFunction.SIN ||
